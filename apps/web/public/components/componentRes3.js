        ...
        products.forEach(product => {
            ...
            productElement.innerHTML = `
                <div class="product-info" style="display: flex; color: #1b1b1b">
                    <p class="product-name text-40" style="margin: 0px">${product.name}</p>
                    <p class="product-dots text-35" style="margin: 0px">${'.'.repeat(product.dots)}</p>
                    <p class="product-price text-40" style="margin: 0px">$${product.price}</p>
                    <p class="product-format text-20" style="margin: 0px">${product.format}</p>
                </div>
            `;
